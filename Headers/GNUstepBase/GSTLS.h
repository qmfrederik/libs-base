 ...
 * cached data.
 */
GS_EXPORT_CLASS @interface      GSTLSObject : NSObject
 ...
 */
GS_EXPORT_CLASS @interface      GSTLSDHParams : GSTLSObject
{
  NSTimeInterval        when;
  NSString              *path;
 ...
 * DH params.
 */
GS_EXPORT_CLASS @interface      GSTLSCertificateList : GSTLSObject
{
  NSTimeInterval        when;
  NSString              *path;
 ...
 */
GS_EXPORT_CLASS @interface      GSTLSPrivateKey : GSTLSObject
{
  NSTimeInterval        when;
  NSString              *path;
  NSString              *password;
 ...
 */
GS_EXPORT_CLASS @interface      GSTLSCredentials : GSTLSObject
{
  NSTimeInterval                        when;
  NSString                              *name;
  GSTLSPrivateKey                       *key;
 ...
 */
GS_EXPORT_CLASS @interface      GSTLSSession : GSTLSObject
{
  NSDictionary                          *opts;
